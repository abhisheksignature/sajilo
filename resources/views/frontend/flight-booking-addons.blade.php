...
<?php include_once('includes/header.php') ?>
                ...
                <div class="row">
                    <div class="col">
                        <nav aria-label="breadcrumb" class="theme-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="flight-layout.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="flight-right-sidebar.php">flights</a></li>
                                <li class="breadcrumb-item"><a href="flight-booking.php">review</a></li>
    ...
    <section class="small-section">
        <div class="container">
            ...
            <div class="continue-btn">
                <button class="btn btn-solid" onclick="window.location.href='flight-booking-payment.php'"
    ...
    <div class="book-panel">
        ...
        <button type="button" onclick="window.location.href='flight-booking-payment.php'"
