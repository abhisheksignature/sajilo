...
<?php include_once('includes/header.php') ?>
    ...
    <section class="hotel-single-section pt-0">
        <img src="assets/images/single-hotel/hotel-out-side2.png" class="bg-img bg-bottom img-fluid blur-up lazyload" alt="">
                    ...
                    <div class="col-12">
                        <div class="hotel-name">
                            ...
                            <div class="right-part">
                                ...
                                <a href="hotel-booking.php" class="btn btn-rounded btn-sm color1">book this now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-9 col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="slide-1 arrow-dark zoom-gallery ratio2_3">
                                    <div>
                                        <a href="assets/images/hotel/room/inside.png">
                                            <img src="assets/images/hotel/room/inside.png"
                                                class="img-fluid blur-up lazyload bg-img w-100" alt="">
                                            <h6 class="view-all">view all images</h6>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="assets/images/hotel/room/inside6.png">
                                            <img src="assets/images/hotel/room/inside6.png"
                                                class="img-fluid blur-up lazyload bg-img w-100" alt="">
                                            <h6 class="view-all">view all images</h6>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="assets/images/hotel/room/inside7.png">
                                            <img src="assets/images/hotel/room/inside7.png"
                                                class="img-fluid blur-up lazyload bg-img w-100" alt="">
                                            <h6 class="view-all">view all images</h6>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="assets/images/hotel/room/inside-9.png">
                                            <img src="assets/images/hotel/room/inside-9.png"
                                                class="img-fluid blur-up lazyload bg-img w-100" alt="">
                                            <h6 class="view-all">view all images</h6>
                                        </a>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 ratio_59">
                                        <div class="slide-1 zoom-gallery no-arrow">
                                            ...
                                            <!-- <div>
                                                <a href="assets/images/hotel/room/8.jpg">
                                                    <img src="assets/images/hotel/room/8.jpg"
                                                        class="img-fluid blur-up lazyload bg-img w-100" alt="">
                                                    <h6 class="view-all">room images</h6>
                                                </a>
                                            </div> -->
                                        ...
                                        <div class="slide-1 zoom-gallery no-arrow m-cls">
                                            <div>
                                                <a href="assets/images/hotel/room/pool-1.png">
                                                    <img src="assets/images/hotel/room/pool-1.png"
                                                        class="img-fluid blur-up lazyload bg-img w-100" alt="">
                                                    <h6 class="view-all">poll images</h6>
                                                </a>
                                            </div>
                                            <div>
                                                <a href="assets/images/hotel/room/pool2.png">
                                                    <img src="assets/images/hotel/pool2.png"
                                                        class="img-fluid blur-up lazyload bg-img w-100" alt="">
                                                    <h6 class="view-all">poll images</h6>
                                                </a>
                                            </div>
                                            <div>
                                                <a href="assets/images/hotel/room/15.jpg">
                                                    <img src="assets/images/hotel/room/15.jpg"
                                                        class="img-fluid blur-up lazyload bg-img w-100" alt="">
                                                    <h6 class="view-all">poll images</h6>
                                                </a>
                                            </div>
                    ...
                    <div class="description-section">
                        <div class="menu-top" id="searchBar">
                            <div class="container">
                                <ul class="nav">
                                    ...
                                    <li><a class="" href="#policy">policies</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="description-details">
                            ...
                            <div class="desc-box">
                                <h4 class="content-title">choose room</h4>
                                ...
                                <div class="menu-part page-section facility" id="facility">
                                    <div class="row">
                                        <div class="col-xl-3 col-6">
                                            <h6><img src="assets/images/icon/hotel/verified.png"
                                        ...
                                        <div class="col-xl-3 col-6">
                                            <h6><img src="assets/images/icon/hotel/credit-card.png"
                                        ...
                                        <div class="col-xl-3 col-6">
                                            <h6><img src="assets/images/icon/hotel/cctv.png"
                                        ...
                                        <div class="col-xl-3 col-6">
                                            <h6><img src="assets/images/icon/hotel/tray.png"
                                                    class="img-fluid blur-up lazyload" alt=""> food & drinks</h6>
                                            <ul>
                                                <li><i class="fas fa-check"></i> restaurant</li>
                                                <li><i class="fas fa-check"></i> bar</li>
                                            </ul>
                                            <h6 class="mt-2"><img src="assets/images/icon/hotel/barbell.png"
                                                    class="img-fluid blur-up lazyload" alt=""> activities</h6>
                                            <ul>
                            ...
                            <div class="desc-box">
                                ...
                                <div class="menu-part policy page-section" id="policy">
                        ...
                        <div class="slider-3 no-arrow">
                            <div>
                                <div class="special-box p-0">
                                    <div class="special-img">
                                        <a href="#">
                                            <img src="assets/images/hotel/gallery/hot1.png"
                            ...
                            <div>
                                <div class="special-box p-0">
                                    <div class="special-img">
                                        <a href="#">
                                            <img src="assets/images/hotel/gallery/hot2.png"
                                                class="img-fluid blur-up lazyload bg-img" alt="">
                                        </a>
                                        <div class="top-icon">
                                            <a href="#" class="" data-bs-toggle="tooltip" data-placement="top" title=""
                            ...
                            <div>
                                <div class="special-box p-0">
                                    <div class="special-img">
                                        <a href="#">
                                            <img src="assets/images/hotel/video-image.jpg"
                                                class="img-fluid blur-up lazyload bg-img" alt="">
                                        </a>
                                        <div class="top-icon">
                                            <a href="#" class="" data-bs-toggle="tooltip" data-placement="top" title=""
                            ...
                            <div>
                                <div class="special-box p-0">
                                    <div class="special-img">
                                        <a href="#">
                                            <img src="assets/images/hotel/gallery/5.jpg"
                                                class="img-fluid blur-up lazyload bg-img" alt="">
                                        </a>
                                        <div class="top-icon">
                                            <a href="#" class="" data-bs-toggle="tooltip" data-placement="top" title=""
                ...
                <div class="col-xl-3 col-lg-4" id="booking">
                    <div class="sticky-cls">
                        <div class="single-sidebar">
                            <div class="selection-section">
                                <div class="overlay-map">
                                    <img src="assets/images/map-image.svg" class="img-fluid blur-up lazyload" alt="">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d193595.9147718689!2d-74.11976358820196!3d40.69740344169578!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2sin!4v1568001991098!5m2!1sen!2sin"
                                        style="border:0;" allowfullscreen=""></iframe>
                                    <h6>view on map</h6>
                                ...
                                <div class="price-part">
                                    <div class="left-part">
                                        <a href="#">Deluxe Rate</a>
                                        <span class="mt-2"><i class="fas fa-check"></i> Room only</span>
                                        <span><i class="fas fa-check"></i> non refundable</span>
                                    </div>
                                    <div class="right-part">
                                        <span>per night</span>
                        ...
                        <div class="single-sidebar">
                            ...
                            <p class="address"> <i class="fas fa-map-marker-alt"></i> Lorem ipsum dolor sit amet,
                                consectetur adipisicing elit.
                            </p>
                            <p><i class="fas fa-phone-alt"></i> 123 254 121</p>
                            <a href="#">
                                <p><i class="fas fa-envelope"></i> Contact@seaview.com</p>
                            </a>
