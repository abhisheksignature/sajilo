                        ...
                        <div class="footer-content">
                            <div class="contact-detail">
                                <div class="footer-logo">
                                    <img src="{{ asset('frontend/images/icon/footer-logo.png') }}" alt="">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('frontend/images/tour/footer/1.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('frontend/images/tour/footer/2.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('frontend/images/tour/footer/3.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('frontend/images/tour/footer/4.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('frontend/images/tour/footer/5.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('frontend/images/tour/footer/6.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                            ...
                            <div class="footer-blog">
                                <div class="media">
                                    <div class="img-part rounded5">
                                        <a href="#">
                                            <img src="{{ asset('frontend/images/cab/blog-footer/1.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                                        </a>
                                ...
                                <div class="media">
                                    <div class="img-part rounded5">
                                        <a href="#">
                                            <img src="{{ asset('frontend/images/cab/blog-footer/2.jpg') }}" class="img-fluid blur-up lazyload" alt="">
                                        </a>
...
<!-- slick js-->
<script src="{{ asset('frontend/js/sticky-search.js') }}"></script>
