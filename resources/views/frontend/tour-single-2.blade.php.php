    ...
    <section class="home_section p-0">
        <div>
            <div class="home home-60">
                <img src="assets/images/tour/spain4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                <div class="container">
                    <div class="row">
                                    ...
                                    <div id="accordion" class="accordion-plan">
                                                    ...
                                                    <div class="highlight">
                                                        <ul>
                                                            <li><img src="assets/images/icon/tour/fork.png"
                                                                    class="img-fluid blur-up lazyload" alt=""> dinner
                                                            </li>
                                                            <li><img src="assets/images/icon/tour/bed.png"
                                                                    class="img-fluid blur-up lazyload" alt=""> night
                                                                stay in madrid</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                                data-bs-parent="#accordion">
                                                <div class="card-body">
                                                    Today we proceed to Toledo - declared as World Heritage Site by
                                                    UNESCO. On arrival we visit the city's most famous monument Santa
                                                    Maria la Blanca Synagogue. Then we visit Sword factory. Later we
                                                    leave for Seville
                                                    <div class="highlight">
                                                        <ul>
                                                            <li><img src="assets/images/icon/tour/fork.png"
                                                            ...
                                                            <li><img src="assets/images/icon/tour/fork.png"
                                                                    class="img-fluid blur-up lazyload" alt=""> lunch
                                                            </li>
                                                            <li><img src="assets/images/icon/tour/fork.png"
                                                                    class="img-fluid blur-up lazyload" alt=""> dinner
                                                            </li>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                                data-bs-parent="#accordion">
                                                <div class="card-body">
                                                    Today we enjoy Seville city tour wherein, we visit the massive
                                                    cathedral with the Tomb of Christopher Columbus, Moorish Giralda
                                                    Tower, The Alcázar, a photo stop at Santa Cruz Quarter with flower
                                                    decked balconies and the Ultramodern expo site - a small scale model
                                                    of "Victoria" the first vessel to circumnavigate the globe. Then we
                                                    visit Metropol Parasol - The largest wooden structure in the world.
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                                data-bs-parent="#accordion">
                                                <div class="card-body">
                                                    Today we proceed to Costa del Sol - a region in the south of Spain.
                                                    Here we explore Puerto Banus, then we proceed to Malaga. On arrival
                                                    we enjoy orientation tour which includes Cathedral of Malaga, Plaza
                                                    de la Merced, The Museo Picasso from outside, then we visit Moorish
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                                data-bs-parent="#accordion">
                                                <div class="card-body">
                                                    Today we proceed to Cordoba. On arrival we visit Mezquita from
                                                    inside followed by orientation city tour which includes Roman
                                                    bridge, Arab waterwheels and Plaza del Potro. Then we leave for
                                                    Valencia.
                                                    <div class="highlight">
                                                        <ul>
                                                            <li><img src="assets/images/icon/tour/fork.png"
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseSix" class="collapse" aria-labelledby="headingSix"
                                                data-bs-parent="#accordion">
                                                <div class="card-body">
                                                    Today we enjoy orientation city tour which includes Plaza del
                                                    Mercado, Serranos Towers, Plaza de Ayuntamento and Cathedral of
                                                    Valencia. Then we visit City of Arts and Sciences- to see the work
                                                    of the Valencian architect Santiago Calatrava, several of its
                                                    buildings have become icons in the city. Then we visit Ceramics
                                                    Museum from inside. Later we proceed to Barcelona. On arrival we
                                                    visit Poble Espanyol – an open air Archaeological museum and Spanish
                                                    village showing replicas of characteristic houses from all regions
                                                    of Spain.
                                                    <div class="highlight">
                                                        <ul>
                                                            <li><img src="assets/images/icon/tour/fork.png"
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven"
                                                data-bs-parent="#accordion">
                                                <div class="card-body">
                                                    Today we enjoy Barcelona city orientation tour which includes
                                                    Olympic stadium, colourful La Ramblas, Statue of Christopher
                                                    Columbus and visit Gaudi's Sagrada Familia Cathedral Antoni Gaudí's
                                                    unfinished masterpiece. Later we take a cable car ride to Montjuic
                                                    hill which gives a panoramic view of the entire Barcelona city and
                                                    Tibidado hill. Today evening we enjoy beach front of Barcelona.
                                                    <div class="highlight">
                                                        <ul>
                                                            <li><img src="assets/images/icon/tour/fork.png"
                                                                    class="img-fluid blur-up lazyload" alt=""> breakfast
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseEight" class="collapse" aria-labelledby="headingEight"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    contact with each other through email, Facebook, and meet again on
                                                    one more memorable tour. See you all!!
                                                    <div class="highlight">
                                                        <ul>
                                                            <li><img src="assets/images/icon/tour/fork.png"
                                                                    class="img-fluid blur-up lazyload" alt=""> breakfast
                                        ...
                                        <div class="list-box">
                                            ...
                                            <div class="list-content">
                                                <div>
                                                    ...
                                                    <p class="hotel-info">relax and unwind with a special stay offer at
                                                        a superlative value. conveniently located, offers spacious
                                                        rooms. great dinning options. gym &amp; pool. innovative dinning
                                                        and bar options. relaxing spa open till 2 A.M.</p>
                                ...
                                <div class="about menu-part" id="policy">
                                    <div class="about-sec">
                                        ...
                                        <ul>
                                            ...
                                            <li>1st part payment 50% of the tour cost at least 60 days prior departure.
                                            </li>
                                    ...
                                    <div class="about-sec">
                                        ...
                                        <ul>
                                            <li>Deposit of INR 1,00,000 per person is non-refundable in any case once
                                    ...
                                    <div class="about-sec">
                                        ...
                                        <ul>
                                            <li>All travelers have to carry their own passports, tickets, forex & any
                                                other important documents. It is recommended to leave passport photocopy
                                                at your resident, office & carry one copy while travelling.</li>
                                            <li>Passengers having excess baggage over 20 kgs per person in check in
                                                baggage & 07 kgs in hand luggage are liable to pay excess baggage charge
                                                directly at airport.</li>
                                            <li>Any sightseeing not mentioned in the itinerary will have to be paid
                                                directly.</li>
                                            <li>For the convenience of passengers the itinerary may be amended.</li>
                                            <li>Flight cost and availability are subject to change at time of actual
                                                booking.</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="single-sidebar">
                            <div class="selection-section">
                                ...
                                <div class="book-btn-section border-top-0">
                                    ...
                                    <a href="tour-booking.php" class="btn btn-rounded btn-sm color1">start my
                                        journey</a>
                                </div>
                            </div>
                        </div>
                        <div class="single-sidebar p-0">
                            <div class="newsletter-sec">
                                <div>
                                    ...
                                    <p>Be the first to find out latest tours and exclusive offers and get 15% off your
                                        first booking.</p>
                                    <form>
