...
@section ('main-container')
    ...
    <section class="breadcrumb-section no-bg pt-0" id="block" style="width: 100%; "
        data-vide-bg="frontend/video/sea.mp4" data-vide-options="position: left, loop: true">
            ...
            <div class="row">
                <div class="col-xl-7  order-xl-1">
                    <div class="image-section">
                        <div class="img-box">
                            <img src="frontend/images/inner-pages/about/dubai-d.png" data-tilt data-tilt-perspective="110"
                        ...
                        <div class="img-box">
                            <img src="frontend/images/inner-pages/about/maldive-d.png" data-tilt data-tilt-perspective="110"
                                data-tilt-speed="400" data-tilt-max="1.2" class="img-fluid blur-up lazyload radius-cls"
                                alt="">
                            <div class="title-box radius-cls">
                                <h3>Maldives</h3>
                        ...
                        <div class="img-box">
                            <img src="frontend/images/inner-pages/about/nepal-d.png" data-tilt data-tilt-perspective="110"
                                data-tilt-speed="400" data-tilt-max="1.2" class="img-fluid blur-up lazyload radius-cls"
                                alt="">
                            <div class="title-box radius-cls">
                                <h3>Nepal</h3>
                ...
                <div class="col-xl-5">
                    <div class="about-text ps-0">
                        <div>
                            ...
                            <p>Lorem Ipsum is the simply dummy text of the printing is of and type the setting the
                                industry.
                                Lorem Ipsum of is has since the 1500s, Lorem Ipsum has been the..... </p>
                            <img src="frontend/images/mix/signature.png" class="img-fluid blur-up lazyload" alt="">
                    ...
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            <div class="testimonial">
                                <div class="left-part">
                                    <img src="frontend/images/avtar/man1.png" class="img-fluid blur-up lazyload" alt="">
                                    <div class="design">
                ...
                <div>
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            <div class="testimonial">
                                <div class="left-part">
                                    <img src="frontend/images/avtar/women.png" class="img-fluid blur-up lazyload" alt="">
                                    <div class="design">
                                        <i class="fas fa-comments"></i>
                                        <i class="fas fa-comments light"></i>
                                    </div>
                ...
                <div>
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            <div class="testimonial">
                                <div class="left-part">
                                    <img src="frontend/images/avtar/man2.png" class="img-fluid blur-up lazyload" alt="">
                                    <div class="design">
                                        <i class="fas fa-comments"></i>
                                        <i class="fas fa-comments light"></i>
                                    </div>
                ...
                <div class="col">
                    <div class="team-slider no-arrow">
                        <div>
                            <div class="team-box">
                                <div class="img-part">
                                    <img src="frontend/images/inner-pages/team/man7.png"
                                ...
                                <div class="team-social radius-cls">
                                    <a href="#" class="social-box">
                                        <img src="frontend/images/icon/social/google.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <a href="#" class="social-box">
                                        <img src="frontend/images/icon/social/twitter.png"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <a href="#" class="social-box">
                        ...
                        <div>
                            <div class="team-box">
                                <div class="img-part">
                                    <img src="frontend/images/inner-pages/team/women2.png"
                                        class="img-fluid blur-up lazyload radius-cls" alt="">
                                </div>
                                <div class="team-content radius-cls">
                                    <h3>Lucas Smith</h3>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="img-part">
                                    <img src="frontend/images/inner-pages/team/man8.png"
                                        class="img-fluid blur-up lazyload radius-cls" alt="">
                                </div>
                                <div class="team-content radius-cls">
                                    <h3>Pablo Himenez</h3>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="img-part">
                                    <img src="frontend/images/inner-pages/team/women1.png"
                                        class="img-fluid blur-up lazyload radius-cls" alt="">
                                </div>
                                <div class="team-content radius-cls">
                                    <h3>Lucas Smith</h3>
    ...
    <!-- blog section start -->
    <section class="blog_section animated-section section-b-space ratio_55">
        <div class="animation-section">
            <div class="cross po-1"></div>
            <div class="cross po-2"></div>
            <div class="cross po-3"></div>
            ...
            <div class="slide-3 no-arrow">
                <div>
                    <div class="blog-wrap">
                        <div class="blog-image">
                            <div>
                                <img src="frontend/images/flights/blog/1.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                ...
                <div>
                    <div class="blog-wrap">
                        <div class="blog-image">
                            <div>
                                <img src="frontend/images/flights/blog/2.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="blog-label">
                                <div>
                ...
                <div>
                    <div class="blog-wrap">
                        <div class="blog-image">
                            <div>
                                <img src="frontend/images/flights/blog/3.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="blog-label">
                                <div>
